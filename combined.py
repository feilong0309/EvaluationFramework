...
def handleArgs():
    ...
    parser.add_argument("-delta","--deltavalue", default=0.7, type=float, help="the delta parameter(the default value is 0.9)", dest="delta")
...
for n in args.n_list:
    ...
    if 'cluster' in args.modules:
        ...
        command_list.append('modularity_optimization')
...
#        --csuf .dat --cnum 2 -o generated_benches/n_1000/ -delta 0.4 -sr 0.7
        ...
        command_list.append(working_directory + 'modularity_optimization_p'+ str(int(100*args.samplerate)) +'_clustering_v')
        ...
        command_list.append(str(args.delta)) 
